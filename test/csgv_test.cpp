...
int main() {
    ...
    {
        Logger(INFO) << "Nibble";
        csgv.setCompressionOptions64(16, NO_RANS);
    ...
    // Single table rANS
    {
        ...
        size_t freq[32];
        csgv.setCompressionOptions64(32, NO_RANS);
        csgv.compressForFrequencyTable(volume.dataConst(), dim, freq, 2, false, false);
        csgv.setCompressionOptions64(32, SINGLE_TABLE_RANS, freq, freq + 16);
        if (!csgv.test(volume.dataConst(), dim, true))
            return 2;
    ...
    // Double table rANS with detail separation
    {
        ...
        size_t freq[32];
        csgv.setCompressionOptions64(64, NO_RANS);
        csgv.compressForFrequencyTable(volume.dataConst(), dim, freq, 2, true, false);
        csgv.setCompressionOptions64(64, DOUBLE_TABLE_RANS, freq, freq + 16);
