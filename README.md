...
Instead of the commandline build from step 4, you can alternatively open the CMake project with an IDE of your choice, e.g. CLion or MS Visual Studio Code.
...
| Vulkan              | 1.3          | GPU programming API            | included in drivers but SDK installation recommended    |
