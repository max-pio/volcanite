...
For file formats that are not supported by Volcanite, see the [converter.py](../python/convert.py) python script for converting
formats.
To download tensorstore volumes or publicly available data sets from BossDB, have a look at the
[download_cloud_data.py](../python/download_cloud_data.py) python scripts.

## Selected Segmentation Volumes

### AZBA - A 3D Adult Zebrafish Brain Atlas (AZBA) for the Digital Age

[Download](https://datadryad.org/dataset/doi:10.5061/dryad.dfn2z351g) (2021-08-22_AZBA_segmentation.nii.gz) | [Download](https://github.com/max-pio/volcanite-evaluation/blob/main/datasets/2021-08-22_AZBA_segmentation.hdf5) (2021-08-22_AZBA_segmentation.hdf5) | [Paper](https://doi.org/10.7554/eLife.69988)

**Description:** A CC0 licensed zebrafish brain atlas. The volume has smaller dimensions making it suitable for testing on low-end machines.

| Voxels           | Labels | Format       | Uncompressed        | Chunked |
|------------------|--------|--------------|---------------------|---------|
| 670, 1224, 470   | 204    | NIfTI / hdf5 | 385.438 MB [uint16] | no      |

Note: Either download the pre-converted hdf5 file or [convert](../python/README.md) the nii.gz file into a suitable format for Volcanite before processing.

*Kenney, Justin W.; Steadman, Patrick E.; Young, Olivia et al. (2021). A 3D Adult Zebrafish Brain Atlas (AZBA) for the Digital Age [Dataset]. Dryad. DOI: 10.5061/dryad.dfn2z351g*
...
| Voxels             | Labels    | Format          | Uncompressed      | Chunked                |
|--------------------|-----------|-----------------|-------------------|------------------------|
| 6144 x 9216 x 4096 | 5,030,572 | Compressed hdf5 | 927.7 GB [uint32] | 6 x 9 x 3 1024³ chunks |
...
| Voxels                 | Labels | Format                   | Uncompressed        | Chunked     |
|------------------------|--------|--------------------------|---------------------|-------------|
| 515892 x 356400 x 5293 | many   | Neuroglancer precomputed | 3540.45 TB [uint32] | tensorstore |
