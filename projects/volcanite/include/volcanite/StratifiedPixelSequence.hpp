...
namespace volcanite {
    ...
    public:
        ...
        static constexpr int pseudoHilbert4x4[16][2] = {{0, 0}, {2, 0}, {2, 2}, {0, 2},
                                                        ...
                                                        {3, 1}, {2, 1}, {3, 2}, {3, 3},
                                                        {2, 3}, {1, 3}, {1, 2}, {0, 3}};
        static constexpr int pseudoHilbert8x8[64][2] = {{0, 0}, {4, 0}, {4, 4}, {0, 4},
                                                        {0, 2}, {2, 2}, {2, 0}, {6, 0},
                                                        {6, 2}, {4, 2}, {6, 4}, {6, 6},
                                                        {4, 6}, {2, 6}, {2, 4}, {0, 6},
                                                        {1, 0}, {1, 1}, {0, 1}, {0, 3},
        ...
        static constexpr int morton4x4[16][2] = {{0,0}, {2,0}, {0,2}, {2,2},
                                                 {1,0}, {0,1}, {1,1}, {3,0},
                                                 {2,1}, {3,1}, {1,2}, {0,3},
                                                 {1,3}, {3,2}, {2,3}, {3,3}};
        static constexpr int morton8x8[64][2] = {{0,0}, {4,0}, {0,4}, {4,4},
                                                 {2,0}, {0,2}, {2,2}, {6,0},
                                                 {4,2}, {6,2}, {2,4}, {0,6},
                                                 {2,6}, {6,4}, {4,6}, {6,6},
                                                 {1,0}, {0,1}, {1,1}, {3,0},
