...
if __name__ == "__main__":
    ...
    for arg_data in VolcaniteArg.args_csgv_datasets.values():
        ...
        for arg_shading in VolcaniteArg.args_shading.values():
            ...
            # vargs = [VolcaniteArg("--verbose"), arg_data, arg_vcfg, arg_shading, arg_timing_export, arg_image_eval, arg_image_export] + data_specific_args(arg_data.identifier)
            vargs = [arg_data, arg_vcfg, arg_shading, arg_timing_export, arg_image_eval, arg_image_export] + data_specific_args(arg_data.identifier)
